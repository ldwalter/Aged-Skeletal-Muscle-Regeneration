...
markers_list <- list(c("Smc4", "Cdk1", "Hmgb2", "Cxcl10", "Ctsa", "Ctsb", "Ctsl", "Ctsz", "Fabp5", "Ly6c2", "Ccr2", "Ccl9", "Ccl6",
                       "Tgfbi", "Ccl2", "Cd68", "Ccl8", "Lyz2", "Itgam", "Cd163", "Mrc1", "C1qa", "Cx3cr1", "Mapk14", "Fcgr3", "Csf1r",
                       "Cxcl16", "Ctss", "Cd200r1", "Fscn1", "Cd74", "H2-Aa", "H2-Ab1", "Cd83", "Itgax", "Flt3", "Xcr1", "Cd72",
                       "Cd209a", "Cxcr4", "Csf1", "S100a8", "S100a9", "Sell", "Cd14", "Mmp9", "Ptprc", "Nkg7", "Ccl5", "Ccr7", "Cd8a",
                       "Cd8b1", "Cd3e", "Cd4", "Foxp3", "Cxcr3", "Cd27", "Tbx21", "Gata3", "Gzma", "Klra4", "Klra7", "Klra8", "Klre1",
                       "Klrd1", "H2-Oa", "H2-Ob", "Igkc", "Ms4a1", "Cd19", "Cd22", "Hba-a1", "Hba-a2", "Hbb-bs", "Hbb-bt"),
                     c("Cd55", "Pi16", "Igfbp5", "Dpp4", "Ly6a", "Hif1a", "Lpl", "Fbln5", "Cxcl12", "Thy1", "Tnfaip6", "Cd164", "Egfr",
                       "Cd34", "Il33", "Hmgb2", "Cdk1", "Smc4", "Mcm5", "Tyms", "Rrm2", "Dio2", "Rspo3",  "Hic1", "Adam12", "Bmp5", "Myoc",
                       "Col3a1", "Bmp1", "Gsn", "Pdgfra", "Bgn", "Hdlbp", "Cxcl5", "Cxcl1", "Ccl7", "Mmp14", "Ctsk", "Col1a1", "Dcn", "Mmp2",
                       "Apod", "Tnmd", "Scx", "Ptn", "Mpz"),
...
# Save plot as PDF
ggsave(filename = "CT_ID_SuppFig.pdf", plot = last_plot(), width = 9, height = 7, units = "in")
